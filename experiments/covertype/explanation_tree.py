...
measurement_df.to_csv("data/experiments/covertype/explanation_tree.csv")
...
fname = 'figures/covertype/explanation_tree_cover_dist_.png'
...
# Save data:
np.savez_compressed("data/experiments/covertype/explanation_tree_assignment.npz", arr=exp_assignment)
np.savez_compressed("data/experiments/covertype/reference_centers.npz", arr=centers)

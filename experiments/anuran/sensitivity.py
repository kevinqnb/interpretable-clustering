...
with open("data/experiments/anuran/alphas/selected_alphas_rule_length.json") as f:
...
outfile = 'data/experiments/anuran/sensitivity/'
outfile_ref = '_min_filter_confidence'

####################################################################################################
# Load pre-mined rules:

decision_tree_rules = load_rules('data/experiments/anuran/rules/decision_tree_rules.pkl')
exkmc_rules = load_rules('data/experiments/anuran/rules/exkmc_rules.pkl')
shallow_tree_rules = load_rules('data/experiments/anuran/rules/shallow_rules.pkl')
forest_rules = load_rules('data/experiments/anuran/rules/forest_rules.pkl')

...
pre_filter_ensemble = load_rules('data/experiments/anuran/rules/pre_filter_ensemble_rules.pkl')

with open('data/experiments/anuran/rules/pre_filter_ensemble_labels.pkl', 'rb') as f:
...
outfile = 'data/experiments/anuran/confidence/'
...
_ids_cache_path = 'data/experiments/anuran/rules/ids_coverage_cache_prefilter.pkl'

...
rules_directory = 'data/experiments/anuran/rules/'
alphas_path = 'data/experiments/anuran/alphas/selected_alphas_resub.json'
outfile = 'data/experiments/anuran/timing/exp_timing.json'

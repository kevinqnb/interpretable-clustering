...
measurement_df.to_csv("data/experiments/anuran/explanation_tree.csv")
...
fname = 'figures/anuran/explanation_tree_cover_dist_.png'
...
# Save data:
np.savez_compressed("data/experiments/anuran/explanation_tree_assignment.npz", arr=exp_assignment)
np.savez_compressed("data/experiments/anuran/reference_centers.npz", arr=centers)

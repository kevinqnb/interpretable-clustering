####################################################################################################
# Shared, unchanging parameters for the anuran experiment pipeline.
#
...
# count; override via ANURAN_TOTAL_CPU_COUNT (or experiment_runner.py's
# --total-cpu-count) to reserve some cores for other work.
TOTAL_CPU_COUNT = int(os.environ.get('ANURAN_TOTAL_CPU_COUNT', os.cpu_count() or 1))
...
# this per subprocess via ANURAN_CPU_COUNT, dividing TOTAL_CPU_COUNT across
...
CPU_COUNT = int(os.environ.get('ANURAN_CPU_COUNT', TOTAL_CPU_COUNT))
...
RULES_DIR = 'data/experiments/anuran/rules/'
ALPHAS_DIR = 'data/experiments/anuran/alphas/'

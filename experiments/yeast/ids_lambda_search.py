...
kmeans_base = KMeansBase(n_clusters=9, random_seed=seed)
...
cache_path = f'data/experiments/yeast/rules/ids_coverage_cache_ensemble_conf_{tag}.pkl'
...
out_path = f'data/experiments/yeast/rules/ids_lambdas_conf_{tag}.json'

...
with open('data/experiments/yeast/rules/ensemble_labels.pkl', 'rb') as f:
...
cache_path = 'data/experiments/yeast/rules/ids_coverage_cache_ensemble.pkl'
...
out_path = 'data/experiments/yeast/rules/ids_lambdas.json'

...
rules_directory = 'data/experiments/yeast/rules/'
alphas_path = 'data/experiments/yeast/alphas/selected_alphas_resub.json'
outfile = 'data/experiments/yeast/timing/exp_timing.json'

####################################################################################################
# Shared, unchanging parameters for the yeast experiment pipeline.
#
...
# count; override via YEAST_TOTAL_CPU_COUNT (or experiment_runner.py's
# --total-cpu-count) to reserve some cores for other work.
TOTAL_CPU_COUNT = int(os.environ.get('YEAST_TOTAL_CPU_COUNT', os.cpu_count() or 1))
...
# overrides this per subprocess via YEAST_CPU_COUNT, dividing
...
CPU_COUNT = int(os.environ.get('YEAST_CPU_COUNT', TOTAL_CPU_COUNT))
...
RULES_DIR = 'data/experiments/yeast/rules/'
ALPHAS_DIR = 'data/experiments/yeast/alphas/'

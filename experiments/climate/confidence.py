...
def run_confidence_level(
    ...
    # already aggregated above (either once, for the pool-independent tree, or
    # per confidence level, for IDS). The PEC-objective score is computed per
    # trial (since it depends on this confidence level's PEC lambda) and

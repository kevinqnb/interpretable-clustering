...
outfile = 'data/experiments/climate/sensitivity/'
outfile_ref = '_min_filter_confidence'

####################################################################################################
# Load pre-mined rules:

decision_tree_rules = load_rules('data/experiments/climate/rules/decision_tree_rules.pkl')
exkmc_rules = load_rules('data/experiments/climate/rules/exkmc_rules.pkl')
shallow_tree_rules = load_rules('data/experiments/climate/rules/shallow_rules.pkl')
forest_rules = load_rules('data/experiments/climate/rules/forest_rules.pkl')

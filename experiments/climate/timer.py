...
from experiments.climate.config import SEED, N_CLUSTERS, N_SELECT_DEFAULT, OUTFILE_REF, RULES_DIR, ALPHAS_DIR
stamp_reset()
...
outfile = f'data/experiments/climate/timing/exp_timing{OUTFILE_REF}.json'

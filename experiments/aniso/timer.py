...
# is small (~170 rules), so n_step=200 collapses this to a single "full pool" step --
# left as the requested starting point; shrink n_step to see a real growth curve.
n_step = 200
n_trials = 10
timing_seed = seed

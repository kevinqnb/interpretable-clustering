...
#
# The other datasets do this in examples/experiments.ipynb (see its `select_alphas` cell), which
# means their selected_alphas_*.json can only be regenerated by hand-running a notebook. aniso is
# a regression fixture that needs to be reproducible from the command line, so the same logic is
# kept here as a script. Reads alphas/exp_resub.json, writes alphas/selected_alphas_resub.json.
...
infile = 'data/experiments/aniso/alphas/exp_resub.json'
outfile = 'data/experiments/aniso/alphas/selected_alphas_resub.json'

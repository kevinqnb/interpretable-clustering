...
cache_path = f'data/experiments/fashion/rules/ids_coverage_cache_ensemble_conf_{tag}.pkl'
...
out_path = f'data/experiments/fashion/rules/ids_lambdas_conf_{tag}.json'

...
from experiments.fashion.config import SEED, N_CLUSTERS, N_SELECT_DEFAULT, OUTFILE_REF, RULES_DIR
...
# class -- except IDS, which is given this seed explicitly below

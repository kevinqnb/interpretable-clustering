...
save_rules(decision_tree_rules, 'data/experiments/fashion/rules/decision_tree_rules.pkl')
save_rules(exkmc_rules, 'data/experiments/fashion/rules/exkmc_rules.pkl')
save_rules(shallow_rules, 'data/experiments/fashion/rules/shallow_rules.pkl')
save_rules(forest_rules, 'data/experiments/fashion/rules/forest_rules.pkl')
save_rules(class_association_rules, 'data/experiments/fashion/rules/class_association_rules.pkl')
save_rules(ensemble_rules, 'data/experiments/fashion/rules/ensemble_rules.pkl')
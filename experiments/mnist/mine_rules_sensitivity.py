...
save_rules(decision_tree_rules, rules_directory + 'decision_tree_rules_sensitivity.pkl')
...
save_rules(exkmc_rules, rules_directory + 'exkmc_rules_sensitivity.pkl')
...
save_rules(shallow_rules, rules_directory + 'shallow_rules_sensitivity.pkl')
...
save_rules(forest_rules, rules_directory + 'forest_rules_sensitivity.pkl')
...
save_rules(ensemble_rules, rules_directory + 'ensemble_rules_sensitivity.pkl')
...
objective_dict = {
    'coverage-mistake': {
        ...
        'alpha_val': 0.0,
        'lambda_val': 0.0,
        'output_path': rules_directory + "mistake_info_dict_sensitivity.pkl.gz"
    },
    'coverage-cost': {
        ...
        'alpha_val': 0.0,
        'lambda_val': 0.0,
        'output_path': rules_directory + "cost_info_dict_sensitivity.pkl.gz"
    },
    'coverage-pairwise-distance': {
        ...
        'alpha_val': 0.0,
        'lambda_val': 0.0,
        'output_path': rules_directory + "pairwise_distance_info_dict_sensitivity.pkl.gz"
    },
}

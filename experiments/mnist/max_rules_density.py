...
outfile_ref = '_rule_length_density'
...
density_filter_params = {
    (i,) : {
        'eps': fixed_parameters['eps'],
        'min_samples': fixed_parameters['min_samples'],
        'max_leaf_nodes': i
    } for i in n_rules_list
}
density_filter_mod = DecisionTreeMod(
    model = DensityFilterTree,
    name = 'DensityFilterTree'
)
...
module_list = [(density_filter_mod, density_filter_params)]

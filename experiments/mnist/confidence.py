...
pre_filter_ensemble = load_rules('data/experiments/mnist/rules/pre_filter_ensemble_rules.pkl')

with open('data/experiments/mnist/rules/pre_filter_ensemble_labels.pkl', 'rb') as f:
...
outfile = 'data/experiments/mnist/confidence/'
...
_ids_cache_path = 'data/experiments/mnist/rules/ids_coverage_cache_prefilter.pkl'

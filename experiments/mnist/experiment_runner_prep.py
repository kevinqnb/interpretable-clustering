#!/usr/bin/env python3
####################################################################################################
# Prep-only runner for the mnist experiment pipeline: runs mine_rules.py ->
...
#   uv run python experiments/mnist/max_rules.py
#   uv run python experiments/mnist/max_rules_exkmc.py
#   uv run python experiments/mnist/max_rules_combine.py
#   uv run python experiments/mnist/confidence.py
#
...
def main():
    parser = argparse.ArgumentParser(
        description=(
            "Run the mnist pipeline's prep stages only (mine_rules -> "
    ...
    print("=== mnist prep stages complete -- run max_rules.py/lambda.py/confidence.py yourself ===")

...
from experiments.mnist.config import SEED, N_CLUSTERS, N_SELECT_DEFAULT, OUTFILE_REF, RULES_DIR, ALPHAS_DIR
stamp_reset()
...
outfile = f'data/experiments/mnist/timing/exp_timing{OUTFILE_REF}.json'
